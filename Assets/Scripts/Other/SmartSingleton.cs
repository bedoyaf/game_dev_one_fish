...
namespace UnityEngine {
    ...
    public abstract class SmartSingleton<T> : MonoBehaviour where T : MonoBehaviour {
        ...
        /// <summary>
        /// Makes every instance automaticaly persistent, even if it's created automaticaly.
        /// </summary>
        protected virtual bool _persistenceOverride => false;
        ...
        protected virtual void Awake() {
            ...
            if (_persistent || _persistenceOverride)
